...
\title{On the Difficulty of Training Non-negative Neural Networks}
...
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight]{images/wcci2026_background_front.pdf}%
}
\frame
{
    \vspace{55pt}
...
\include{sections/0_intro/intro}
% \include{sections/1_adaptinit/adaptinit}
% \include{sections/2_quant/quant}
% \include{sections/3_mixedquant/mixedquant}
\include{sections/4_nn/nn}
% \include{sections/5_mult/mult}
% \include{sections/6_conclusions/conclusion}
